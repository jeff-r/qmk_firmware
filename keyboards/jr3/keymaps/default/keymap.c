...
//         {KC_END,   KC_PGDN,  MT(MOD_LCTL, KC_ESC),   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    MT(MOD_RALT, KC_K),  MT(MOD_RGUI, KC_L),     KC_SCOLON, MT(MOD_RCTL, KC_QUOTE),    KC_ENTER,  KC_CAPS },
//         {KC_UP,    KC_DOWN,  KC_LSFT,  MT(MOD_LGUI,KC_Z),    MT(MOD_LALT,KC_X),    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLASH,  KC_RSFT,     KC_BSLASH,   KC_BSLASH },
//         {KC_LEFT,  KC_RIGHT, KC_LCTL,  KC_LGUI, KC_LALT, F(JR_LAYER_ONCE),  KC_BSPC,  KC_SPC,  KC_SPC,  F(JR_LAYER_TOGGLE),  KC_RALT, KC_LGUI,  KC_RCTL,   KC_RALT,     KC_LGUI,     KC_RCTL }
...
//         {KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  LSFT(KC_9),  LCTL(LALT(KC_P)),  F(JR_TMUX_COPY),  F(JR_TMUX_PASTE),  F(JR_NERDTREE)  },
